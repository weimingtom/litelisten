...
public class ColorDialog
{
	...
	public static void ShowMessage(Activity act, View WindowParent, String Title, float MessageFontSize, int DefaultColor, OnClickListener onOK)
	{
		...
		ColorPicker cpv = new ColorPicker(act, DefaultColor, 1.5, edtMessage);
