...
public class WidgetMedium extends AppWidgetProvider
{
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds)
	{
		...
		{
			RemoteViews rv = new RemoteViews(context.getPackageName(), R.layout.widget_medium);
			...
			// 上一首，使用控制消息
			intent = new Intent(context, WidgetMedium.class);
	...
	public void onReceive(Context context, Intent intent)
	{
		...
		{// 标题和时间
			...
			rv.setTextViewText(R.id.txtWidgetLRC, Html.fromHtml(intent.getStringExtra("LRCMedium")));
		...
		ComponentName cname = new ComponentName(context, WidgetMedium.class);
